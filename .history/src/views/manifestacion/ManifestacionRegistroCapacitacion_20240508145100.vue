  ...
  setup() {
    ...
    async function catalogoEspecilidad() {
      try {
        ...
        if (capacitacionStore.object.catalogoDisciplina.result.length >= 0) {
          dataEspecialidad.value = {
            result: capacitacionStore.object.catalogoDisciplina.result,
          };
        }
      } catch (error) {}
    }
    ...
    async function catalogoModalidad() {
      try {
        ...
        if (capacitacionStore.object.catalogoModalidad.result.length >= 0) {
          dataModalidad.value = {
            result: capacitacionStore.object.catalogoModalidad.result,
          };
        }
      } catch (error) {}
    }
          ...
          if (capacitacionStore.type == "success") {
            ...
            */
            ...
            dialogPropiedades.value = {
              dialog: true,
              mensajeTitulo: "Capacitación externa",
              mensajeCuerpo: "Revise los datos obligatorios",
              correcto: false,
            };
            /*
            await showAlert(
