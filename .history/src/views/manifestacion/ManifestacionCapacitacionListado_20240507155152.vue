...
export default defineComponent({
  ...
  setup() {
    ...
    async function cargarPermisos() {
      ...
      if (
        Array.isArray(manifestacionStore.object.listadoPermisos) &&
        manifestacionStore.object.listadoPermisos.length > 0
      ) {
    ...
    async function cargarDashboard() {
      ...
      try {
        ...
        if (
          ...
          listadoCapacitaciones.value = { dataset: manifestacionStore.object.listado };
        }
      } catch (error) {}
    }
    ...
    async function guardarDatos() {
      ...
      dialogPropiedades.value = {
        ...
        mensajeCuerpo: "Se notificará cuando sea autorizada para que pueda descargarla",
        correcto: true,
      };
    }
