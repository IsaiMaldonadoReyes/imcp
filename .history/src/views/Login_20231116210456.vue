<template>
  <v-container class="fill-height" style="display: grid">
    ...
    <v-row dense align-self="start" justify="start">
      <v-col cols="12" lg="12" md="12" sm="12" align="center">
        <v-img class="logo" max-height="90px" max-width="300px" src="../assets/images/logotipo.svg" />
      </v-col>
    </v-row>
    <v-row dense align="center">
      ...
      <v-col cols="12" lg="12" md="12" sm="12" class="px-10">
        <v-text-field :rules="[rules.required, rules.validRFC]" v-model="form.rfc" clearable label="RFC" rounded="lg"
          style="font-weight: bold" variant="solo" @input="() => convertToUpperCase('rfc')" />
      </v-col>
      <v-col cols="12" lg="12" md="12" sm="12" class="px-10">
        <v-text-field :append-inner-icon="show1 ? 'mdi-eye' : 'mdi-eye-off'" :rules="[rules.required]"
          :type="show1 ? 'text' : 'password'" v-model="form.password" clearable label="Contraseña" rounded="lg"
          style="font-weight: bold" variant="solo" @click:append-inner="show1 = !show1" />
      </v-col>
      <v-col cols="12" lg="12" md="12" sm="12" class="px-10" align="right">
        <v-btn class="text-caption text-disabled ms-1 text-capitalize" color="#C6092F" rounded="lg" size="x-small"
          style="font-weight: bold" variant="plain" @click="resetPassword">
