<template>
  <ion-page>
    <ion-content>
      <v-container class="ma-# pa-# fill-height bg-surface-variant">
        <v-row no-gutters align="start" style="height: 10%" class="d-flex align-center justify-center">
          <img style="max-width:80%; max-height: 80%" src="../assets/images/logotipo.svg" />
        </v-row>
        <v-row style="height: 60%" class="d-flex align-start justify-center">
