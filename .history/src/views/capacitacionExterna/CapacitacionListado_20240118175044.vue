              ...
              <v-card border class="ma-3" elevation="0">
                ...
                >
                  ...
                  <template v-slot:bottom="{ pageCount }">
                    <v-divider />
                    <div class="text-center my-3 mx-3" v-if="item.raw.dataset.length > 1">
                      <v-select
...
export default defineComponent({
  ...
  setup() {
    ...
    const encabezadosEvento = ref([
      { title: "Especialidad", key: "EventosNombreEvento" },
      { title: "Fecha", key: "NombreColegio" },
      { title: "Lugar", key: "NumeroRegistro" },
      { title: "Puntos generados", key: "EventosFechaFin" },
      { title: "Estatus", key: "AsistenciaHora" },
    ]);
