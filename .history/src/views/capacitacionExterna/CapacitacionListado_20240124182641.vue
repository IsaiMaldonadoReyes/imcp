      ...
      <v-container>
        ...
        <v-window v-model="tabs">
          ...
          <v-window-item :value="2">
            <v-card elevation="0" rounded="b-lg">
              <v-card class="mx-auto" color="transparent" elevation="0">
                <v-card-item>
                  <v-card-title
...
export default defineComponent({
  ...
  setup() {
    ...
    const encabezadosEvento = ref([
      { title: "Especialidad", key: "modalidad", align: "center" },
      { title: "Fecha", key: "eventos_fecha_inicio", align: "center" },
      { title: "Lugar", key: "eventos_sede", align: "center" },
      { title: "Puntos generados", key: "puntos", align: "center" },
