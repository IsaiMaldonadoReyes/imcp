  ...
  <ion-page>
    <ion-content>
      <v-container>
        ...
        >
          <v-tab :value="1" color="#C60A2F" slider-color="#C60A2F" size="x-small"  variant="flat" class="mr-3 rounded-t-lg"> Periodo anual </v-tab>

          <v-tab :value="2" height="" color="#C60A2F" slider-color="#C60A2F" size="x-small" variant="flat" rounded="rounded-t-lg"> Periodo 4 años </v-tab>
        </v-tabs>
