...
export default defineComponent({
  ...
  setup() {
    const headers = ref([
      ...
      { title: "Protein (g)", key: "fechaVisible", removable: true },
      { title: "Iron (%)", key: "totalHoras", removable: true },
      { title: "Iron (%)", key: "totalPuntos", removable: true },
    ]);
    const desserts = ref([
      {
        name: "Frozen Yogurt",
      ...
      },
      {
        ...
        eventos: [
          ...
          },
          {
            ...
            fechaVisible: new Date("25/04/2023")
              .toISOString()
              .slice(0, 10)
              .split("-")
              .reverse()
              .join("/"),
            fecha: new Date("25/04/2023"),
            totalHoras: 4,
            totalPuntos: 8,
          },
          {
            ...
            fechaVisible: new Date("11/11/2023")
              .toISOString()
              .slice(0, 10)
              .split("-")
              .reverse()
              .join("/"),
            fecha: new Date("11/11/2023"),
            totalHoras: 50,
            totalPuntos: 50,
          },
        ],
