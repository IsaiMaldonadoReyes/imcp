    ...
    <ion-content>
      <v-container>
        ...
        <v-tabs
          ...
          rounded="lg"
          density="compact"
          style="border-bottom-color: red !important;"
        >
          <v-tab :value="1" color="red" slim size="small" class="blue-tab mr-3 rounded-t-lg"> Periodo anual </v-tab>

          <v-tab :value="2" color="red" slim size="small" class="blue-tab rounded-t-lg"> Periodo 4 años </v-tab>
        </v-tabs>
