      ...
      <v-container>
        <v-card class="mb-3" elevation="0" rounded="lg" border>
          <v-card-title class="text-h6 font-weight-bold"
            >Total de puntos por evento</v-card-title
          >
          <v-table density="compact">
            <tbody>
              <tr >
                <th class="text-left" style="border-bottom: none">Curso:</th>
                <td class="text-subtitle-1 text-grey-darken-1 font-weight-bold" style="border-bottom: none">
                  Administración de Alcaldías
                </td>
              </tr>
              <tr>
                <th class="text-left" style="border-bottom: none">Colegio:</th>
                <td class="text-subtitle-1 text-grey-darken-1 font-weight-bold" style="border-bottom: none">
                  CCP México
                </td>
              </tr>
              <tr>
                <th class="text-left" style="border-bottom: none">Sector:</th>
                <td class="text-subtitle-1 text-grey-darken-1 font-weight-bold">
