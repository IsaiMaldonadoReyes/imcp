  ...
  <ion-page>
    <ion-content>
      <v-container>
        ...
        >
          <v-tab :value="1" color="red" slim size="small"  variant="flat" class="mr-3 rounded-t-lg"> Periodo anual </v-tab>

          <v-tab :value="2" color="red" slim size="small" variant="flat" class="rounded-t-lg"> Periodo 4 años </v-tab>
        </v-tabs>
