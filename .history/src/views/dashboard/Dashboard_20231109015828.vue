...
import { Chart, registerables, ChartScriptableContext } from "chart.js";

Chart.register(...registerables, ChartScriptableContext);
  ...
  setup() {
    ...
    const options = ref({
      ...
      animation: {
        ...
        delay: (context: ChartScriptableContext) => {
          let delay = 0;
