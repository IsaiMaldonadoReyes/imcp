      ...
      <v-container fluid>
        ...
        <v-card class="my-3" elevation="0" rounded="lg" border>
          ...
          <v-card-text>
            ...
            <br />
            <span class="text-subtitle-1">Total de puntos:</span>
            <span class="text-subtitle-1 text-grey-darken-1 font-weight-bold">
              142
            </span>
            <br />
            <span class="text-subtitle-1">Certificado:</span>
            <span class="text-subtitle-1 text-grey-darken-1 font-weight-bold">
              EUC
            </span>
            <br />
            <span class="text-subtitle-1">Fecha emisión:</span>
            <span class="text-subtitle-1 text-grey-darken-1 font-weight-bold">
              2019-02-01
            </span>
            <br />
            <span class="text-subtitle-1">Cumplimiento NDPCA artículo 2.9:</span>
            ...
            <br />
            <span class="text-subtitle-1">Fecha vigencia:</span>
            <span class="text-subtitle-1 text-grey-darken-1 font-weight-bold">
              2023-01-31
            </span>
          </v-card-text>
