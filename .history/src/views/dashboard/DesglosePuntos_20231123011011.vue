...
export default defineComponent({
  ...
  setup() {
    ...
    function parseDate(dateString: string) {
      ...
      // Crear un nuevo objeto Date con el formato ajustado (año-mes-día) y zona horaria UTC
      return new Date(
