    ...
    <ion-content>
      <v-container>
        <v-card class="mb-3" elevation="0" rounded="lg" border>
          <v-card-title class="text-h6 font-weight-bold">Total de puntos por evento</v-card-title>
          <v-table density="compact" :outlined="false">
            <tbody>
              <tr >
                <th class="text-left" :border="false">Curso:</th>
                <td class="text-subtitle-1 text-grey-darken-1 font-weight-bold">Administración de Alcaldías</td>
              </tr>
              <tr>
                <th class="text-left">Colegio:</th>
                <td class="text-subtitle-1 text-grey-darken-1 font-weight-bold">CCP México</td>
              </tr>
              <tr>
                <th class="text-left">Sector:</th>
                <td class="text-subtitle-1 text-grey-darken-1 font-weight-bold">Académico tiempo completo</td>
              </tr>
            </tbody>
          </v-table>
        </v-card>
