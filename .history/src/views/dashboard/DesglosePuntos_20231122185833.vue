          ...
          >
            <template v-slot:header>
              <v-toolbar class="px-2">
                ...
                <v-btn-toggle class="mx-4" v-model="sortDesc"  elevation="1">
                  <v-btn color="red" :value="'asc'" @click="console.log(sortDesc)">
                    <v-icon>mdi-arrow-up</v-icon>
                  </v-btn>
                  <v-btn color="ref" :value="'desc'" @click="console.log(sortDesc)">
                    ...
                    <v-card grow class="pb-3" border flat>
                      ...
                      <div class="d-flex justify-space-between px-3 pt-2">
                        ...
                        >
                          ...
                          <span class="text-h6 text-red-darken-1 font-weight-bold">
                            {{ item.raw.totalHoras }}
                          </span>
                        </div>
