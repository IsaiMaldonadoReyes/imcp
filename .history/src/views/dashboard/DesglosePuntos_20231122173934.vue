            ...
            <template v-slot:header>
              <v-toolbar class="px-2">
                ...
                <v-btn-toggle class="mx-4" v-model="sortDesc">
                  <v-btn color="primary" :value="true" @click="console.log(sortDesc)" />
                  <v-btn color="primary" :value="false" @click="console.log(sortDesc)" />
                </v-btn-toggle>
              </v-toolbar>
            </template>
...
export default defineComponent({
  ...
  setup() {
    ...
    const sortBy = ref([{ text: "duración", value: "duration", key: "duration", order: sortDesc }]);
