    ...
    <ion-content>
      <v-container>
        <v-card class="mb-3" elevation="0" rounded="lg" border>
          ...
          <v-card-text>
            <span class="text-subtitle-1 text-left">Curso:</span>
            <span class="text-subtitle-1 text-left"> Administración de Alcaldías</span>
          </v-card-text>
          <v-table density="compact">
            <tbody>
              <tr>
                <th class="text-subtitle-2 text-left" style="border-bottom: none">
                  Curso:
                </th>
                <td
