  ...
  <ion-page>
    <ion-content>
      <v-container>
        ...
        >
          <v-tab :value="1" color="red" slim size="small" class="blue-tab mr-3 rounded-lg"> Periodo anual </v-tab>

          <v-tab :value="2" color="red" slim size="small" class="blue-tab rounded-lg"> Periodo 4 años </v-tab>
        </v-tabs>
