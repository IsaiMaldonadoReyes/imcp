  ...
  <ion-page>
    <ion-content>
      <v-container>
        ...
        <v-data-table class="HistoryTable" :headers="headers" >
<MobileTableHelper cssClass="HistoryTable" :headers="headers"></MobileTableHelper>
...
<script lang="ts">
import MobileTableHelperVue from "@/components/MobileTableHelper.vue";
