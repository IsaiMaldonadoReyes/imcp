...
export default defineComponent({
  ...
  setup() {
    ...
    const data = [30, 40, 20, 5];
    const data2 = [10, 20, 10, 50];
    const data3 = [50, 30, 30, 40];
    ...
    const chartData = computed(() => ({
      labels: ["Esperado 2022", "Obtenido 2022", "Esperado 2021", "Obtenido 2021", "Esperado 2020", "Obtenido 2020"],
      datasets: [
        {
          label: "Principales",
          data: data,
