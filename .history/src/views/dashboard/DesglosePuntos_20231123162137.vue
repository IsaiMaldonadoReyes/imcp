            ...
            <template v-slot:header>
              <v-toolbar class="px-2">
                ...
                <v-btn-toggle class="mx-4" v-model="sortDesc" elevation="2">
                  <v-btn size="small" color="#B20000" :value="'asc'" icon="mdi-arrow-up"> </v-btn>
                  <v-btn size="small" color="#B20000" :value="'asc'" icon="mdi-menu-down"></v-btn>
                  <v-btn size="small" color="#B20000" :value="'desc'" icon="mdi-arrow-down"></v-btn>
                </v-btn-toggle>
              </v-toolbar>
            </template>
