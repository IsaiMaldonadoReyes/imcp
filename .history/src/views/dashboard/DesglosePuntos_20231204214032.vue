    ...
    <ion-content>
      <v-container fluid>
        ...
        <v-card class="my-3" elevation="0" rounded="lg" border>
          ...
          <v-card-text>
            <span class="text-subtitle-1 text-medium-emphasis">Colegio:</span>
            <span class="text-subtitle-1 text-grey-darken-1 font-weight-bold">
              CCP México
            </span>
            <br />
            <span class="text-subtitle-1 text-medium-emphasis">Núm. Certificado:</span>
            <span class="text-subtitle-1 text-grey-darken-1 font-weight-bold">
              14382
            </span>
            <br />
            <span class="text-subtitle-1 text-medium-emphasis">Total de puntos:</span>
            <span class="text-subtitle-1 text-grey-darken-1 font-weight-bold">
              142
            </span>
            <br />
            <span class="text-subtitle-1 text-medium-emphasis">Certificado:</span>
            <span class="text-subtitle-1 text-grey-darken-1 font-weight-bold">
              EUC
            </span>
            <br />
            <span class="text-subtitle-1 text-disabled">Fecha emisión:</span>
            <span class="text-subtitle-1 text-grey-darken-1 font-weight-bold">
              2019-02-01
            </span>
            <br />
            <span class="text-subtitle-1 text-disabled">Cumplimiento NDPCA artículo 2.9:</span>
            <span class="text-subtitle-1 text-red-darken-1 font-weight-bold">
              Inactivo
            </span>
            <br />
            <span class="text-subtitle-1 text-disabled">Sector:</span>
            <span class="text-subtitle-1 text-grey-darken-1 font-weight-bold">
              Académico tiempo completo
            </span>
            <br />
            <span class="text-subtitle-1 text-disabled">Fecha vigencia:</span>
            <span class="text-subtitle-1 text-grey-darken-1 font-weight-bold">
              2023-01-31
            </span>
          </v-card-text>
