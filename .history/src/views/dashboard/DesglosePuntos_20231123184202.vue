      ...
      <v-container>
        ...
        <v-card class="my-3" elevation="0" rounded="lg" border>
          ...
          >
            <v-list-item>
              <v-list-item-title>
                <span class="text-caption text-disabled" style="letter-spacing: normal"
                  >Tipo de puntos</span
                >
              </v-list-item-title>
              <template v-slot:append>
                <span class="text-caption text-disabled" style="letter-spacing: normal">Estatus de proceso</span>
              </template>
            </v-list-item>
