        ...
        <v-card>
          ...
          >
            <template v-slot:header>
              <v-toolbar class="px-2" extended extension-height="100">
                <v-row>
                  <v-col cols="12">
                    <v-text-field
                      v-model="search"
                ...
                <v-select
                  ...
                  variant="solo"
                ></v-select>
                <v-btn-toggle class="mx-4" v-model="sortDesc" elevation="2" density="comfortable">
                  <v-btn size="small" color="#B20000" :value="'asc'" icon="mdi-arrow-up">
                  </v-btn>
                  <v-btn
                    size="small"
                    color="#B20000"
