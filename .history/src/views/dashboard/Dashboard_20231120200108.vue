  ...
  <ion-page>
    <ion-content>
      <v-container>
        ...
        >
          <v-tab :value="1" height="30px" color="#C60A2F" slider-color="#C60A2F" size="x-small"  variant="flat" rounded="t-lg" class="mr-3"> Periodo anual </v-tab>

          <v-tab :value="2" height="30px" color="#C60A2F" slider-color="#C60A2F" size="x-small" variant="flat" rounded="t-lg"> Periodo 4 años </v-tab>
        </v-tabs>
