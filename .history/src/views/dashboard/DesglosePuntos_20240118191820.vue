...
.tb-puntos.v-data-table td::before {
  content: attr(data-label);
}

.tb-puntos.v-data-table td:last-child {
  border-bottom: 0;
}

.tb-puntos.v-data-table tr:not(:first-child) > td:first-child {
