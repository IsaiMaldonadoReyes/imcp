            ...
            <template v-slot:header>
              <v-toolbar class="px-2">
                ...
                <v-btn-toggle class="mx-4" v-model="sortDesc" elevation="2">
                  <v-btn color="#B20000" :value="'asc'">
                    <v-icon>mdi-arrow-up</v-icon>
                  </v-btn>
                  <v-btn color="#B20000" :value="'desc'">
...
export default defineComponent({
  ...
  setup() {
    ...
    let sortBy = ref([]);
    // Define una referencia para el arreglo resultante
    const arregloResultado = ref([]);

    // Método para convertir la lista de objetos a un arreglo
    const convertirAarreglo = () => {
      arregloResultado.value = sortBy.value.map((objeto) => objeto);
    };
