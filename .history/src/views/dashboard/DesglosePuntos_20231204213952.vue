    ...
    <ion-content>
      <v-container fluid>
        ...
        <v-card class="my-3" elevation="0" rounded="lg" border>
          ...
          <v-card-text>
            <span class="text-subtitle-1 text-disabled">Colegio:</span>
            <span class="text-subtitle-1 text-grey-darken-1 font-weight-bold">
              CCP México
            </span>
            <br />
            <span class="text-subtitle-1 text-disabled">Núm. Certificado:</span>
            <span class="text-subtitle-1 text-grey-darken-1 font-weight-bold">
              14382
            </span>
            <br />
            <span class="text-subtitle-1 text-disabled">Total de puntos:</span>
            <span class="text-subtitle-1 text-grey-darken-1 font-weight-bold">
              142
            </span>
            <br />
            <span class="text-subtitle-1 text-disabled">Certificado:</span>
            <span class="text-subtitle-1 text-grey-darken-1 font-weight-bold">
              EUC
            </span>
            <br />
