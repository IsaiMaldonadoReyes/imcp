    ...
    const games = ref([
      {
        ...
        fecha: new Date("02/20/2023").toISOString().slice(0, 10).split("-").reverse().join("/"),
        totalHoras: 18,
        totalPuntos: 18,
      },
      {
        ...
        colegio: "CCP México",
        numRegistro: "CCPGJ-FEME-001-01-2023",
        fecha: new Date("02/20/2023").toLocaleDateString("en-US", {
          year: "numeric",
          month: "2-digit",
          day: "2-digit",
        }),
      ...
      },
      {
        ...
        fecha: new Date("02/01/2023").toISOString().slice(0, 10).split("-").reverse().join("/"),
        totalHoras: 15,
        totalPuntos: 15,
      },
      {
