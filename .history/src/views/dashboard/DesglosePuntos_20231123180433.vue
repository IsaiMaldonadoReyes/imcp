          ...
          <v-table density="compact">
            <tbody>
              <tr>
                ...
                <td class="text-grey-darken-1 font-weight-bold">Administración de Alcaldías</td>
              </tr>
              <tr>
                <th class="text-left">Colegio:</th>
                <td class="text-grey-darken-1 font-weight-bold">CCP México</td>
              </tr>
              <tr>
                <th class="text-left">Sector:</th>
                <td class="text-grey-darken-1 font-weight-bold">Académico tiempo completo</td>
              </tr>
            </tbody>
          </v-table>
        </v-card>
