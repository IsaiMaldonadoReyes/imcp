                    ...
                    <v-card grow class="pb-3" border flat>
                      <v-list-item class="mb-2">
                        <template v-slot:title>
                          <span class="text-body-2 font-weight-ligh text-medium-emphasis">Área de especialidad</span>
                        </template>
                        <strong class="text-h6 mb-2 font-weight-bold">
                      ...
                      <v-list-item class="mb-2">
                        ...
                        <strong class="text-subtitle-1 mb-2">
                          {{ item.raw.evento }}
                        </strong>
                      </v-list-item>
