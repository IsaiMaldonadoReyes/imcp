  ...
  <ion-page>
    <ion-content>
      <v-container>
        ...
        >
          <v-tab :value="1" color="red" slim size="small" class="blue-tab mr-3 rounded-t-xl"> Periodo anual </v-tab>

          <v-tab :value="2" color="red" slim size="small" class="blue-tab rounded-t-xl"> Periodo 4 años </v-tab>
        </v-tabs>
