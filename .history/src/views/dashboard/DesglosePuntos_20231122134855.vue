                ...
                >
                  <template v-slot:prepend>
                    <v-tooltip color="primary" right>
                      ...
                      <span>
                        Herramienta de ordenamiento de información:
                        <br />seleccionar el atributo de ordenamiento.
                      </span>
                    </v-tooltip>
                  </template>
                </v-select>
...
export default defineComponent({
  ...
  setup() {
    ...
    const keys = ref([{ text: "Titulo", value: "title" }]);
    ...
    return { search, games, sortedGames, SelectItemKey, sortBy, keys };
  },
});
</script>
