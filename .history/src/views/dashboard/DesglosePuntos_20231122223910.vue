...
export default defineComponent({
  ...
  setup() {
    ...
    let sortBy = ref(["areaEspecialidad", "totalHoras"]);

    const keys = ref([
      {
        text: "Área de especialidad",
    ...
    return { search, games, SelectItemKey, sortBy, keys, sortDesc, keysProps };
  },
});
</script>
