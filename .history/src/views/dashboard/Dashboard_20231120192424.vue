  ...
  <ion-page>
    <ion-content>
      <v-container>
        ...
        <v-tabs v-model="tabs" color="red" grow :stacked="true" bg-color="transparent" rounded="lg" density="compact">
          <v-tab :value="1" color="white" fixed="true" > Periodo anual </v-tab>

          <v-tab :value="2"> Periodo 4 años </v-tab>
        </v-tabs>
