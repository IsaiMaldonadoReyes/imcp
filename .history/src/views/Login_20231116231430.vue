<template>
  <v-container class="ma-# ma-# fill-height">
    <v-row height="20%" align="start" justify="center">
        <img style="width: 70%" src="../assets/images/logotipo.svg" />
        <!-- Contenido -->
      </v-row>
    <v-card color="transparent" elevation="0" height="100%">
      
      <v-row height="80%" dense align="center" justify="center">
        <v-col
