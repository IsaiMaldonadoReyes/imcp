    ...
    <ion-header>
      <v-layout>
        ...
        <v-app-bar color="#EBEFF0">
          ...
          <v-btn class="text-none" icon variant="outlined" color="#B01F24">
            <v-badge class="small-dot" content="2" color="#B01F24" location="center">
              <v-icon color="#B01F24" size="x-large">mdi-bell</v-icon>
            </v-badge>
          </v-btn>
...
.esquina-tl {
    background: url("../images/esquina_superior_izquierda.png") top left no-repeat;
    z-index: -1;
    background-size: 20%;
}
</style>
