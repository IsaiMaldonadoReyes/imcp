            ...
            >
              ...
              <template v-slot:append-inner>
                <v-menu v-model="menu" :close-on-content-click="false" location="end">
                  <template v-slot:activator="{ props }">
                    <v-icon v-bind="props">mdi-information-circle</v-icon>
                  </template>

                  <v-card min-width="300" class="ma-2 pa-2">
                    <v-card-text>
                      El código <span class="font-weight-bold">CVV</span> o
                      <span class="font-weight-bold">CVC</span> es un grupo de 3 o 4
                      números situado en el reverso de la tarjeta de crédito o débito.
                    </v-card-text>
                    <v-divider></v-divider>
