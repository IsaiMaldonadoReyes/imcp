          ...
          <v-card-text>
              ...
              <template v-slot:append>
                <v-menu v-model="menu" :close-on-content-click="false" location="end">
                  ...
                  <v-card min-width="300" class="ma-2 pa-2">
                    <v-card-text>
                      El código <span></span>CVV o CVC es un grupo de 3 o 4 números
                      situado en el reverso de la tarjeta de crédito o débito.
                    </v-card-text>
                    <v-divider></v-divider>
            ...
            <v-checkbox :center-affix="true" true-icon="mdi-shield-check" hide-details>
              ...
              <template v-slot:append>
                ...
                <span class="text-caption text-ligth-emphasis ms-1 font-weight-light">
                  streaming
                </span>
              </template>
            </v-checkbox>
