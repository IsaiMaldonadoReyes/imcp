          ...
          <template v-slot:default="{ items }">
            ...
            >
              ...
              <v-card
                ...
                class="ma-1"
              >
                <v-slide-group show-arrows mobile-breakpoint="xs" class="estatus-ejercicios">
                  <v-slide-group-item
                    v-for="(item, i) in item.raw.revisionAnual"
                    :key="i"
                  >
                    <v-card class="ma-1" height="100" width="50%" elevation="0" border>
                      <v-icon
...
<style>
.estatus-ejercicios .v-slide-group__next,
.estatus-ejercicios .v-slide-group__prev {
  flex: 0px !important;
