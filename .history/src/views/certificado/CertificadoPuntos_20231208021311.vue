            ...
            <v-col cols="4">
              ...
              >
                <p
                  ...
                  :style="`color: ${colores.verdeBoton}; line-height: 1 !important;`"
                >
                  Puntaje principal
                </p>
                <p class="my-2 text-h6 text-grey-darken-1">20/20</p>
              </v-card>
            </v-col>
            <v-col cols="4">
              <v-card
              ...
              >
                <v-card-title>
                  class="text-body-2 font-weight-bold" :style="`color:
                  ${colores.verdeBoton}; line-height: 1 !important;`" > Puntaje otros
                  cursos
                </v-card-title>
                <p class="my-2 text-h6 text-grey-darken-1">55/55</p>
              </v-card>
            </v-col>
            <v-col cols="4">
              <v-card
              ...
              >
                ...
                <p class="my-2 text-h6 text-grey-darken-1">5/5</p>
              </v-card>
            </v-col>
          </v-row>
        </v-card>
