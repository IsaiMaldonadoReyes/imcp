            ...
            <v-table density="compact">
              <tbody>
                ...
                <tr>
                  ...
                  <td class="ma-0 pa-1 font-weight-bold text-left">0000111</td>
                </tr>
                <tr>
                  <td class="ma-0 pa-1 text-subtitle-1 text-grey-darken-1">Fecha:</td>
                  <td class="ma-0 pa-1 font-weight-bold text-justify">
                    2023-01-10 xsssssss ssss
                  </td>
                </tr>
                <tr>
                  <td class="ma-0 pa-1 text-subtitle-1 text-grey-darken-1">Sector:</td>
