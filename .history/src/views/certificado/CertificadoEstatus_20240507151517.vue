  ...
  setup() {
    ...
    async function cargarDesglosePorEjercicio() {
      ...
      try {
        ...
        if (
          Array.isArray(certificadoStore.object.certificadosPendientes) &&
          certificadoStore.object.certificadosPendientes.length > 0
        ) {
          certificadosPendientes.value = {
            dataset: certificadoStore.object.certificadosPendientes,
          };
        }
      } catch (error) {}
    }
