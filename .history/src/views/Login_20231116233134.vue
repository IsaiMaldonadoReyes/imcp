<template>
  <v-container class="ma-# pa-# fill-height">
    <v-row align-selft="center" justify="center">
      <img style="width: 60%" src="../assets/images/logotipo.svg" />
    </v-row>
    <v-card color="transparent" elevation="0" height="100%">
      <v-row height="100%" dense class="d-flex justify-center align-self-center">
        <v-col
