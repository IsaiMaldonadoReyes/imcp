    ...
    <ion-header>
      <v-layout>
        <v-app-bar color="#EBEFF0">
          ...
          <v-btn class="text-none" color="#D3151E" icon variant="outlined">
            <v-badge class="small-dot" content="2" text-color="#ffffff" location="center">
              <v-icon color="#D3151E" size="x-large">mdi-bell</v-icon>
            </v-badge>
          </v-btn>
    ...
    <ion-tabs>
      ...
      <ion-tab-bar slot="bottom">
        <ion-tab-button tab="dashboard" href="/tabs/dashboard">
          <v-icon size="30" icon="mdi-chart-pie-outline
Added in v7.1.96
Created by Google
import Icon from '@mdi/react';
import { mdiChartPieOutline } from '@mdi/js';

<Icon path={mdiChartPieOutline} size={1} />
Math
report-pie-outline
widget-pie-outline
graph-pie-outline
