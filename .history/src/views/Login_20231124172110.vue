  ...
  <ion-page>
    <ion-content>
      <v-container class="ma-# pa-# fill-height">
        <v-row style="height: 15%" class="d-flex align-center justify-center">
          <img style="max-width: 65%; max-height: 65%" src="../assets/images/logotipo.svg" />
        </v-row>
        <v-row style="height: 50%" class="d-flex align-start justify-center">
