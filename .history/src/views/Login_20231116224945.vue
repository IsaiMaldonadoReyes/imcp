<template>
  <ion-page>
    <ion-content :fullscreen="true">
      <v-container class="bg-surface-variant" class="fill-height">
      <v-row
        no-gutters
      >
        <v-col align-self="start">
          <v-sheet class="pa-2 ma-2">
            <img style="width: 200px" src="../assets/images/logotipo.svg" />
      ...
      <v-container class="fill-height" fluid>
        <v-card color="transparent" elevation="0" class="my-0 py-0">
          <v-layout>
