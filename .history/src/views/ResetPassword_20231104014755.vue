  ...
  <v-container class="fill-height" style="display: grid">
    ...
    <v-row dense align="center">
      <v-col
        ...
        sm="12"
      >
        <v-label style="font-size: 24px; font-weight: bold">Recuperación de contraseña</v-label>
      </v-col>
      ...
      <v-col cols="12" lg="12" md="12" sm="12" class="px-10" align="right">
        <span @click="redirectLogin" class="text-caption text-disabled ms-1" style="font-weight: bold">
          Ir a login
        </span>
      </v-col>
      <v-col cols="12" lg="12" md="12" sm="12" class="px-10">
