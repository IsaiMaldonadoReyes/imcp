  ...
  setup(props, { emit }) {
    ...
    onMounted(async () => {
      ...
      LottieAnimation.loadAnimation({
        animationData: JSON.parse(JSON.stringify(animationData.value)),
        loop: "false",
        autoPlay: "true",
        speed: "dialogPropiedades.velocidad",
        class: "lottie-container",
    ...
    watch(
      ...
      (newValue) => {
        ...
        import("../../assets/images/" + props.dialogRoute + ".json").then((module) => {
          var1.value = module.default; // modify var1 by assigning to var1.value
        });
      }
    );
