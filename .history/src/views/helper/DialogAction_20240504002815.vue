<template>
  <v-dialog v-model="dialogPropiedades.dialog" max-width="500px">
    <div class="icon-box">
      <lottie-animation ref="anim"
      :animationData=require(`../../assets/images/incorrect.json`) :loop="false"
      :autoPlay="true" :speed="dialogPropiedades.velocidad" class="lottie-container" />
    </div>
    <v-card class="pa-6">
      <v-card-text
...
export default defineComponent({
  ...
  setup(props, { emit }) {
    ...
    onMounted(() => {
      ...
      animationData.value = await import(`../../assets/images/incorrect.json`);
    });
