...
export const useCertificadoStore = defineStore({
    ...
    state: () => ({
        object: {
            ...
            puntosPorCertificado: {dataset: [], totalSize: 0},
            desglosePuntos: {},
            rutaPdf: '',
        },
        responseMessage: "",
    ...
    actions: {
        ...
        async cargarCertificadosPendientes() {
            ...
            this.object.certificadosPendientes = {dataset: [], totalSize: 0};
        ...
        async cargarPuntosPorCertificado(idCertificado: any, anhioInicio: any, anhioFin: any) {
            ...
            this.object.puntosPorCertificado = { dataset: [], totalSize: 0 };
            ...
            try {
                const params = {
                    datos: {
                        cuenta_rfc: rfcParam,
                        id_especialidad_general: idCertificado,
